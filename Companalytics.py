...
#username = Companalytics
#password = Companalytics
...
label = customtkinter.CTkLabel(master=frame, text="Companalytics", font=("Roboto",24))
...
def main():
    ...
    try:
        ...
        print("Sorry that is not a valid country name or the country did not play in 2022 world cup, please re-run program ")
    ...
    if second_player not in list(second_df["Player"]):
        ...
        print("The player is not available or did not play in the 2022 world cup")
        exit()
    ...
    for name, goals, assists in zip(
        ...
        if name == first_player:
            total_ga = float(goals)+float(assists)
    ...
    print(" -----------")
    print(" ")
    print("〣THANK YOU! The Comparision Graph Has Been Stored In You PC〣")
    print("************************************************************************************************************************************")
